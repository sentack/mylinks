...
export function DisplayMinimal({
  fullName,
  bio,
  avatarUrl,
  socialLinks = {},
    ...
    <div className="w-full p-4 text-center space-y-2">
      ...
      {avatarUrl && (
        <div className="flex justify-center mb-4">
          <img src={avatarUrl || "/placeholder.svg"} alt={fullName} className="w-16 h-16 rounded-full object-cover" />
        </div>
      )}
      ...
      {/* Bio */}
      {bio && <p className="text-sm text-gray-600 dark:text-gray-400">{bio}</p>}
